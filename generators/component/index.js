...
module.exports = yeoman.generators.Base.extend({
  initializing: function () {
    ...
    this.props.component = _.camelCase(this.props.name);
  },

  writing: function () {
    this.fs.copy(
      this.templatePath('component.js'),
      this.destinationPath(format('%s/%s/%s.component.js', this.props.root, this.props.feature, this.props.component))
    );
    ...
    focus.push(format('  .component(\'%s\', require(\'./%s.component.js\'))', this.props.component, this.props.component));
